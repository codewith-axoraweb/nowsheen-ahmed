...
const initialReviews: Review[] = [
  ...
  { id: "8", name: "Fatima Ahmed", country: "Hyderabad, Pakistan", message: "Copywriting was persuasive and effective.", rating: 4, service: "Copywriting", date: "2024-10-10", timestamp: new Date("2024-10-10").getTime() },
  ...
  { id: "11", name: "Hassan Raza", country: "Hyderabad, Pakistan", message: "SEO content was well-researched.", rating: 4, service: "SEO Content", date: "2024-07-20", timestamp: new Date("2024-07-20").getTime() },
  ...
  { id: "14", name: "Zainab Malik", country: "Hyderabad, Pakistan", message: "Website content was user-friendly.", rating: 4, service: "Website Content", date: "2024-04-30", timestamp: new Date("2024-04-30").getTime() },
  ...
  { id: "18", name: "Bilal Sheikh", country: "Hyderabad, Pakistan", message: "Copywriting was compelling!", rating: 4, service: "Copywriting", date: "2023-12-25", timestamp: new Date("2023-12-25").getTime() },
  ...
  { id: "21", name: "Sana Iqbal", country: "Hyderabad, Pakistan", message: "SEO content was keyword-rich.", rating: 4, service: "SEO Content", date: "2023-09-20", timestamp: new Date("2023-09-20").getTime() },
  ...
  { id: "34", name: "Zara Ali", country: "Hyderabad, Pakistan", message: "Website content was engaging.", rating: 4, service: "Website Content", date: "2022-09-30", timestamp: new Date("2022-09-30").getTime() },
  ...
  { id: "37", name: "Hina Butt", country: "Hyderabad, Pakistan", message: "Blog posts were well-written.", rating: 5, service: "Blog Writing", date: "2022-06-10", timestamp: new Date("2022-06-10").getTime() },
  ...
  { id: "40", name: "Saba Qureshi", country: "Hyderabad, Pakistan", message: "Editing was thorough.", rating: 5, service: "Editing", date: "2022-03-15", timestamp: new Date("2022-03-15").getTime() },
  ...
  { id: "43", name: "Asadullah Khan", country: "Hyderabad, Pakistan", message: "Copywriting was impactful.", rating: 4, service: "Copywriting", date: "2021-12-25", timestamp: new Date("2021-12-25").getTime() },
  ...
  { id: "46", name: "Amir Hussain", country: "Hyderabad, Pakistan", message: "SEO content was effective.", rating: 4, service: "SEO Content", date: "2021-09-20", timestamp: new Date("2021-09-20").getTime() },
